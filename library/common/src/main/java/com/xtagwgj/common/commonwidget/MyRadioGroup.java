...
public class MyRadioGroup extends LinearLayout {
    ...
    /**
     * set the no_data_default checked radio button, without notification the listeners
     * @param mCheckedId the no_data_default checked radio button's id, if none use -1
     */
