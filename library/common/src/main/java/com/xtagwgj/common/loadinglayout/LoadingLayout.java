package com.xtagwgj.common.loadinglayout;
...
public class LoadingLayout extends FrameLayout {
    ...
    private void build() {
        ...
        loadingPage.setBackgroundColor(DisplayUtils.getColor(mContext,backgroundColor));
        errorPage.setBackgroundColor(DisplayUtils.getColor(mContext,backgroundColor));
        emptyPage.setBackgroundColor(DisplayUtils.getColor(mContext,backgroundColor));
        networkPage.setBackgroundColor(DisplayUtils.getColor(mContext,backgroundColor));

        errorText = DisplayUtils.findViewById(errorPage, R.id.error_text);
        emptyText = DisplayUtils.findViewById(emptyPage, R.id.empty_text);
        networkText = DisplayUtils.findViewById(networkPage, R.id.no_network_text);

        errorImg = DisplayUtils.findViewById(errorPage, R.id.error_img);
        emptyImg = DisplayUtils.findViewById(emptyPage, R.id.empty_img);
        networkImg = DisplayUtils.findViewById(networkPage, R.id.no_network_img);

        errorReloadBtn = DisplayUtils.findViewById(errorPage, R.id.error_reload_btn);
        networkReloadBtn = DisplayUtils.findViewById(networkPage, R.id.no_network_reload_btn);
        ...
        errorText.setTextColor(DisplayUtils.getColor(mContext, tipTextColor));
        emptyText.setTextColor(DisplayUtils.getColor(mContext, tipTextColor));
        networkText.setTextColor(DisplayUtils.getColor(mContext, tipTextColor));
        ...
        errorReloadBtn.setTextColor(DisplayUtils.getColor(mContext, buttonTextColor));
        networkReloadBtn.setTextColor(DisplayUtils.getColor(mContext, buttonTextColor));

        if (buttonHeight != -1) {

            errorReloadBtn.setHeight(DisplayUtils.dp2px(mContext, buttonHeight));
            networkReloadBtn.setHeight(DisplayUtils.dp2px(mContext, buttonHeight));
        }
        if (buttonWidth != -1) {

            errorReloadBtn.setWidth(DisplayUtils.dp2px(mContext, buttonWidth));
            networkReloadBtn.setWidth(DisplayUtils.dp2px(mContext, buttonWidth));
        }
    ...
    public LoadingLayout setReloadButtonTextColor(@ColorRes int id) {
        ...
        errorReloadBtn.setTextColor(DisplayUtils.getColor(mContext, id));
        networkReloadBtn.setTextSize(DisplayUtils.getColor(mContext, id));
        return this;
    }
